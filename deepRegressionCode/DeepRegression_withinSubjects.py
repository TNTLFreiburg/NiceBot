...
for Settings in [0]:
    ...
    for adam in [True, False]:
        ...
        for subjName in Subjects:
            ...
            plt.savefig(dir_outputData + '/' + subjName +  saveAddonText + '_fig_lc_fold.png', bbox_inches='tight')
            ...
            exp.epochs_df.to_csv(dir_outputData + '/' + subjName + saveAddonText , sep=',', header=False)
            ...
            plt.savefig(dir_outputData + '/' + subjName +  saveAddonText + '_fig_predResp.png', bbox_inches='tight', dpi=300)   
            log.info("-----------------------------------------")
            ...
            if calcViz:
                ...
                for l in range(len(phase_pert_corrs)):
                    ...
                    scipy.io.savemat(dir_outputData + '/' + subjName +  saveAddonText + '_phiPrtCC' + '_layer{:d}'.format(l) + '.mat', {'layer_cc':layer_cc})
                    layer_cc = amp_pert_corrs[l]
                    scipy.io.savemat(dir_outputData + '/' + subjName +  saveAddonText + '_ampPrtCC' + '_layer{:d}'.format(l) + '.mat', {'layer_cc':layer_cc})
